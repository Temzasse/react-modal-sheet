import { useContext, createContext, useRef, useCallback, useEffect, forwardRef, useState, useImperativeHandle, createElement, Children, cloneElement } from 'react';
import { createPortal } from 'react-dom';
import { useMotionValue, useSpring, AnimatePresence, motion, useTransform } from 'framer-motion';
...
var Sheet = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var sheetDragY = useMotionValue(isBrowser ? window.innerHeight : 0);
  var sheetSpringY = useSpring(sheetDragY, springConfig);
  ...
  return mounted ? createPortal(createElement(SheetContext.Provider, {
    value: context
  ...
  createElement("div", Object.assign({}, wrapperProps));
});
